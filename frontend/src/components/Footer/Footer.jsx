...
const Footer = () =>{
    ...
    return(
        <div class="container-fluid" style={{backgroundColor: 'rgba(141, 140, 140, 0.5)', borderColor:'rgba(141, 140, 140)'}}>
            <footer class="py-5 ">
                <div class="row">
                ...
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Settings</a></li>
